...
public enum Comentario {
	...
	Registro("Se intenta registrar el(a) %s %s"), Actualizacion("Se intenta actualizar el(a) %s con los datos %s"),
	Eliminacion("Se intenta eliminar el(a) %s %s"), Reporte("Se intenta generar el(a) reporte de %s"),
	Visita("Se intenta visitar la página de %s"), VisitaConsulta("Se intenta visitar la página de Consulta de %s"),
