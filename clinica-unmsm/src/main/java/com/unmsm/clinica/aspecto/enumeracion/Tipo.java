...
public enum Tipo {
	/* Mantenimiento */
	Alumno("Alumno"), Medico("Médico"), MulTabCab("Tabla de Tablas"), MulTabDet("Detalle de Tabla de Tablas"),
	Persona("Persona"), Campania("Campaña"),

	/* Reporte */
	RptAutCanal("Reporte de Autorización de Canal"), RptMovAut("Reporte de Movimiento de Autorización"),
	...
	/* Seguridad */
	Rec("Recurso"), Usu("Usuario"), CatRec("Categoría de Recurso"),
