...
public class Conversor {
	...
	public static Date dateValueOf(String date) throws ParseException {
		return (date == null || date.isEmpty()) ? new Date() : new SimpleDateFormat("dd-MM-yyyy").parse(date);
	}
	...
	public static Map<String, Object> toMapJSON(Map<String, Object> mapOriginal, Map<String, Object> mapJSON)
