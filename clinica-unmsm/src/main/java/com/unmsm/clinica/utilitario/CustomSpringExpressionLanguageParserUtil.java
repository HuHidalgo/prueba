...
public class CustomSpringExpressionLanguageParserUtil {
	...
	public static String getDynamicValue(String[] parameterNames, Object[] args, String datos) {
		...
		for (String atributo : atributos) {
			...
			String nombreAtributo = StringsUtils.obtenerCadenaAntesDe(atributo, SEPARADOR_ATRIBUTO_VALOR);
			String valorAtributoSpel = StringsUtils.obtenerCadenaDespuesDe(atributo, SEPARADOR_ATRIBUTO_VALOR);
			try {
				oValorAtributo = parser.parseExpression(valorAtributoSpel).getValue(context, Object.class);
