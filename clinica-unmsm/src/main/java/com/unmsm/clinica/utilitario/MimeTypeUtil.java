...
public class MimeTypeUtil {
	...
	public static final Map<String, String> EXTENSIONES = ImmutableMap.of(PDF, EXTENSION_PDF, PNG, EXTENSION_PNG, JPEG,
			EXTENSION_JPEG, XLSX, EXTENSION_XLSX, DOCX, EXTENSION_DOCX);
