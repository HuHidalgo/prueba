...
public class ConstantesExcepciones {
	...
	public static final String NO_EXISTE_REPORTE_EXAMEN_MEDICO_INGRESANTE = "El Alumno <b>no cuenta con todos los resultados completos</b> de Examen Médico Ingresante.";

	/* Error constructor estático */
	public static final String NO_INSTANCIAR_CLASE_ESTATICA = "No puede instanciar una clase estática.";

	// public static final ImmutableMap<Integer, String> EXCEPCIONES_MYSQL =
	// ImmutableMap.of(547, VIOLACION_CLAVE_FORANEA);
