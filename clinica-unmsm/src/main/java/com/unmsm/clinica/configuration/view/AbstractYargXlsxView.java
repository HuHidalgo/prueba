...
public abstract class AbstractYargXlsxView extends AbstractView {
	...
	protected void renderMergedOutputModel(Map<String, Object> model, HttpServletRequest request,
		...
		response.setHeader("Content-Disposition",
				StringsUtils.concatenarCadena("attachment;filename=", nombreReporte, MimeTypeUtil.EXTENSION_XLSX));
		response.setContentType(getContentType());
		renderReport(reporting, runParams, response);
	}

	protected abstract void buildExcelDocument(Map<String, Object> model, ReportBuilder reportBuilder,
	...
	protected void renderReport(Reporting reporting, RunParams runParams, HttpServletResponse response)
			throws IOException {
