package com.unmsm.clinica.controller.movimiento;
...
public @Controller class ResultadoExamenMedicoController {
	...
	public String irPaginaRegistroResultadoExamenMedicoLaboratorio(@PathVariable String examen, ModelMap model) {
	...
	public String irPaginaRegistroResultadoExamenMedicoRadiologico(@PathVariable String examen, ModelMap model) {
		model.addAttribute("examen", examen);
		model.addAttribute("resultadosRadiologico",
				multiTabDetService.buscarPorIdTabla(MultiTablaUtil.TABLA_RESULTADO_RADIOLOGICO));
		return "seguras/resultado/registroResultado";
