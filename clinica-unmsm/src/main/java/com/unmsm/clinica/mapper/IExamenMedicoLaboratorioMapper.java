...
public interface IExamenMedicoLaboratorioMapper extends IMantenibleMapper<ExamenMedicoLaboratorio> {
	@Select(value = { "{call MANT_EXAMEN_MEDICO_LABORATORIO ( " + "#{verbo, jdbcType = VARCHAR, mode = IN},"
			...
			+ "#{objeto.tipoAlumno, jdbcType = VARCHAR, mode = IN}," + "#{objeto.idRPR, jdbcType = VARCHAR, mode = IN},"
