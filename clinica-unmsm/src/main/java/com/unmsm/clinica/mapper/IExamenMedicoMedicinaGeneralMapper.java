...
public interface IExamenMedicoMedicinaGeneralMapper extends IMantenibleMapper<ExamenMedicoMedicinaGeneral> {
	@Select(value = { "{call MANT_EXAMEN_MEDICO_MEDICINA_GENERAL ( " + "#{verbo, jdbcType = VARCHAR, mode = IN},"
			...
			+ "#{objeto.tipoAlumno, jdbcType = VARCHAR, mode = IN}," + "#{objeto.embarazo, jdbcType = BIT, mode = IN},"
