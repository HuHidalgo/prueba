...
public interface IExamenMedicoOdontologiaMapper extends IMantenibleMapper<ExamenMedicoOdontologico> {
	@Select(value = { "{call MANT_EXAMEN_MEDICO_ODONTOLOGIA ( " + "#{verbo, jdbcType = VARCHAR, mode = IN},"
			...
			+ "#{objeto.idHigiene, jdbcType = CHAR, mode = IN}," + "#{objeto.idProtesis, jdbcType = CHAR, mode = IN},"
