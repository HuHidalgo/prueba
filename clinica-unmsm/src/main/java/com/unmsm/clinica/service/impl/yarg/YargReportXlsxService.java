package com.unmsm.clinica.service.impl.yarg;
...
import com.unmsm.clinica.service.IYargReportXlsxService;
import com.unmsm.clinica.utilitario.ConstantesGenerales;
import com.unmsm.clinica.utilitario.Conversor;
...
public class YargReportXlsxService implements IYargReportXlsxService {
	...
	protected void buildExcelDocument(Map<String, Object> model, ReportBuilder reportBuilder,
		...
		String rutaTemplateExcel = getClass().getClassLoader().getResource(StringsUtils
				.concatenarCadena(ConstantesGenerales.RUTA_REPORTE_XLSX, templateExcel, MimeTypeUtil.EXTENSION_XLSX))
				.getPath();
		ReportTemplateBuilder reportTemplateBuilder = new ReportTemplateBuilder().documentPath(rutaTemplateExcel)
				.documentName(StringsUtils.concatenarCadena(templateExcel, MimeTypeUtil.EXTENSION_XLSX))
	...
	protected void renderReport(Reporting reporting, RunParams runParams, ByteArrayOutputStream output) {
