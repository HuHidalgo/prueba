$(document).ready(function() {
	...
	$local.$buscar.on("click", function() {
		...
		$.ajax({
			type : "GET",
			url : $variableUtil.root + "reporte/atencion/diaria/registrados/laboratorio?accion=buscar",
	...
	$local.$exportar.on("click", function() {
		...
		window.location.href = $variableUtil.root + "reporte/atencion/diaria/registrados/laboratorio?accion=exportar&" + paramCriterioBusqueda;
	});
});