$(document).ready(function() {
	...
	$local.$buscar.on("click", function() {
		...
		$.ajax({
			type : "GET",
			url : $variableUtil.root + "reporte/atencion/diaria/psicologia?accion=buscar",
	...
	$local.$exportar.on("click", function() {
		...
		window.location.href = $variableUtil.root + "reporte/atencion/diaria/psicologia?accion=exportar&" + paramCriterioBusqueda;
	});
