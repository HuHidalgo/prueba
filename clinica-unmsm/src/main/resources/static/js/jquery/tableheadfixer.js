	...
	$.fn.tableHeadFixer = function(param) {
		...
		function table() {

			{
				...
				/*
				 * This function solver z-index problem in corner cell where fix
				 * row and column at the same time, set corner cells z-index 1
				 * more then other fixed cells
				 */
				function setCorner() {
